 ...
 * @author Vasile Dirla
 */
public class ExecuteTimerJobsCmd extends ExecuteJobsCmd implements Serializable {

  public ExecuteTimerJobsCmd(String jobId) {
    super(jobId);
  }
  public ExecuteTimerJobsCmd(JobEntity job) {
    super(job);
  }
  @Override
