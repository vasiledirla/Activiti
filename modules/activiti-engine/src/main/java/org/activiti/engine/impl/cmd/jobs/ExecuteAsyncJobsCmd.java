 ...
 * @author Vasile Dirla
 */
public class ExecuteAsyncJobsCmd extends ExecuteJobsCmd implements Serializable {

  public ExecuteAsyncJobsCmd(String jobId) {
    super(jobId);
  }
  public ExecuteAsyncJobsCmd(JobEntity job) {
    super(job);
  }
  @Override
