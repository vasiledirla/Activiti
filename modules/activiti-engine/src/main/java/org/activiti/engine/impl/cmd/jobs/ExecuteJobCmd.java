 ...
 */
public abstract class ExecuteJobCmd extends JobCmd<Object> implements Serializable {
  ...
  public ExecuteJobCmd(JobEntity job) {
    this.job = job;
  }
  ...
  public Object executeCommand(CommandContext commandContext) {
    ...
    getJobEntityManager(commandContext).execute(job);
