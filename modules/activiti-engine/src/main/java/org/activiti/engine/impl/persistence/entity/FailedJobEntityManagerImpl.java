 ...
 * @author Vasile Dirla
 */
public class FailedJobEntityManagerImpl extends AbstractJobEntityManager<FailedJobEntity> implements FailedJobEntityManager {

  private static final Logger logger = LoggerFactory.getLogger(FailedJobEntityManagerImpl.class);

  protected FailedJobDataManager jobDataManager;

  public FailedJobEntityManagerImpl(ProcessEngineConfigurationImpl processEngineConfiguration, FailedJobDataManager jobDataManager) {
  ...
  @Override
  public void insert(FailedJobEntity jobEntity, boolean fireCreateEvent) {
  ...
  @Override
  public List<FailedJobEntity> findJobsByExecutionId(String executionId) {
  ...
  public List<FailedJobEntity> selectRetriableJobs(Page page) {
    return jobDataManager.selectRetriableJobs(page);
  }
  ...
  public FailedJobDataManager getJobDataManager() {
    return jobDataManager;
  }

  public void setJobDataManager(FailedJobDataManager jobDataManager) {
    this.jobDataManager = jobDataManager;
  }
