 ...
 * @author Vasile Dirla
 */
public class GetTimerJobExceptionStacktraceCmd extends GetJobExceptionStacktraceCmd implements Serializable {

  public GetTimerJobExceptionStacktraceCmd(String jobId) {
    super(jobId);
  }
  @Override
