 ...
 * @author Vasile Dirla
 */
public  class GetAsyncJobExceptionStacktraceCmd extends GetJobExceptionStacktraceCmd implements Serializable {

  public GetAsyncJobExceptionStacktraceCmd(String jobId) {
    super(jobId);
  }
  @Override
