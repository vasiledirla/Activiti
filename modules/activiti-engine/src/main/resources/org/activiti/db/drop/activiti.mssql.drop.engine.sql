...
if exists (select TABLE_NAME from INFORMATION_SCHEMA.TABLES where TABLE_NAME = 'ACT_RU_ASYNC_JOB') alter table ACT_RU_JOB drop constraint ACT_FK_ASYNC_JOB_EXCEPTION;
if exists (select TABLE_NAME from INFORMATION_SCHEMA.TABLES where TABLE_NAME = 'ACT_RU_TIMER_JOB') alter table ACT_RU_JOB drop constraint ACT_FK_TIMER_JOB_EXCEPTION;
...
if exists (select TABLE_NAME from INFORMATION_SCHEMA.TABLES where TABLE_NAME = 'ACT_RU_ASYNC_JOB') drop table ACT_RU_ASYNC_JOB;
