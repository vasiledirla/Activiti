...
if exists (select TABLE_NAME from INFORMATION_SCHEMA.TABLES where TABLE_NAME = 'ACT_RU_ASYNC_JOB') alter table ACT_RU_ASYNC_JOB drop constraint ACT_FK_ASYNC_JOB_EXCEPTION;
