...
if exists (select TABLE_NAME from INFORMATION_SCHEMA.TABLES where TABLE_NAME = 'ACT_RU_FAILED_JOB') drop table ACT_RU_FAILED_JOB;
if exists (select TABLE_NAME from INFORMATION_SCHEMA.TABLES where TABLE_NAME = 'ACT_RU_LOCKED_JOB') drop table ACT_RU_LOCKED_JOB;
