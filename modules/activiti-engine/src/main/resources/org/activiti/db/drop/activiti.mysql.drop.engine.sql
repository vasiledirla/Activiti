...
drop FOREIGN KEY ACT_FK_LOCKED_JOB_EXCEPTION;
...
drop FOREIGN KEY ACT_FK_FAILED_JOB_EXCEPTION;
...
drop table if exists ACT_RU_LOCKED_JOB;
drop table if exists ACT_RU_TIMER_JOB;
drop table if exists ACT_RU_FAILED_JOB;
